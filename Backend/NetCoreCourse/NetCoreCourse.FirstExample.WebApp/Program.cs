...
var customConfigurationObject = builder.Configuration.GetSection("CustomConfiguration");
builder.Services.Configure<CustomConfigurationOptions>(customConfigurationObject);
